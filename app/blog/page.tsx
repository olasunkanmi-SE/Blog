      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-gray-50 to-white dark:from-gray-900 dark:to-gray-800 py-24">
        ...
        <div className="container relative mx-auto px-6">
          <div className="mx-auto max-w-4xl text-center">
            <div className="mb-6 inline-flex items-center rounded-full bg-amber-50 px-4 py-2 text-sm font-medium text-amber-600 dark:bg-amber-900/20 dark:text-amber-400">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-8">
            ...
            <div className="space-y-8">
              {displayPosts.map((post, index) => {
                ...
                return (
                  <article key={slug} className="group relative overflow-hidden rounded-xl bg-white shadow-lg transition-all duration-300 hover:shadow-xl dark:bg-gray-800">
                    {/* Featured badge for first post */}
                    {index === 0 && (
                      <div className="absolute top-4 right-4 z-10 rounded-full bg-gradient-to-r from-amber-500 to-orange-500 px-3 py-1 text-xs font-semibold text-white">
                        Latest
                      </div>
                    )}
                    ...
                    <div className="p-6">
                      <div className="space-y-4">
                          ...
                          <div className="flex flex-wrap gap-2 pt-3">
                            {tags?.slice(0, 3).map((tag) => (
                              <Tag
                                key={tag}
                                text={tag}
                                className="rounded-full bg-amber-50 px-3 py-1 text-xs font-medium text-amber-700 transition-all duration-200 hover:bg-amber-100 dark:bg-amber-900/30 dark:text-amber-300 dark:hover:bg-amber-900/50"
                              />
                            ))}
                            {tags && tags.length > 3 && (
                        ...
                        <div className="flex items-center justify-between pt-4 border-t border-gray-100 dark:border-gray-700">
                          ...
                          <Link
                            href={`/blog/${slug}`}
                            className="rounded-lg bg-gradient-to-r from-amber-600 to-orange-600 px-4 py-2 text-sm font-semibold text-white shadow-lg transition-all duration-200 hover:scale-105 hover:shadow-xl focus:outline-none focus:ring-4 focus:ring-amber-300 dark:focus:ring-amber-800"
          ...
          <div className="lg:col-span-4">
            <div className="sticky top-8 space-y-8">
              ...
              {/* Newsletter Signup */}
              <div className="overflow-hidden rounded-xl bg-gradient-to-br from-amber-500 to-orange-600 p-6 text-white shadow-lg">
                <div className="mb-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="rounded-xl bg-white p-4 text-center shadow-lg dark:bg-gray-800">
