      ...
      <div className="mx-auto mb-24 grid h-auto max-w-7xl auto-rows-min grid-cols-4 gap-x-4 pt-0 md:grid-cols-8 lg:relative lg:mb-64 lg:min-h-[40rem] lg:grid-cols-12 lg:gap-x-6 lg:pb-12 lg:pt-24">
        <div className="col-span-full pt-6 lg:col-span-5 lg:col-start-1 lg:row-start-1 lg:flex lg:h-full lg:flex-col">
          ...
          <p className="mb-6 max-w-2xl  text-gray-500 dark:text-gray-400 md:text-lg lg:mb-8 lg:text-xl">
            I'm a software engineer with a passion for crafting robust and
            innovative solutions. Currently, I am actively exploring the fields
            of machine learning and AI
          </p>
          <div className="flex w-full">
            <Link
              href="/blog"
              className="mr-3 inline-flex items-center justify-center rounded-lg bg-amber-600 px-5 py-3 text-center text-base font-medium text-white hover:bg-yellow-950 focus:ring-4 focus:ring-primary-300 dark:focus:ring-primary-900"
            >
              View my blog
            </Link>
            <Link
            ...
            >
              ...
              <span
                aria-hidden
                className="before:content-['YouTube'] sm:group-hover:before:content-['Subscribe!']"
              ></span>
