      ...
      <div className="relative mx-auto mb-32 grid h-auto max-w-7xl auto-rows-min grid-cols-4 gap-x-4 pt-8 md:grid-cols-8 lg:mb-72 lg:min-h-[45rem] lg:grid-cols-12 lg:gap-x-8 lg:pb-16 lg:pt-32">
        <div className="col-span-full pt-8 lg:col-span-6 lg:col-start-1 lg:row-start-1 lg:flex lg:h-full lg:flex-col lg:justify-center">
          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center">
            ...
            <Link
              ...
              target="_blank"
              className="group inline-flex items-center justify-center gap-3 rounded-2xl border-2 border-red-500 bg-red-500 px-8 py-4 text-base font-semibold text-white shadow-lg transition-all duration-300 hover:scale-105 hover:bg-red-600 hover:border-red-600 hover:shadow-xl focus:outline-none focus:ring-4 focus:ring-red-300"
            >
              <Youtube aria-hidden className="h-5 w-5 fill-current" />
        ...
        <div className="col-span-full mt-16 flex items-center justify-center lg:col-span-6 lg:col-start-7 lg:mt-0 lg:px-0">
          <div className="relative w-full max-w-lg lg:max-w-none">
            ...
            <div className="absolute -top-4 -left-4 h-24 w-24 rounded-full bg-gradient-to-br from-amber-400 to-orange-500 opacity-20 blur-xl"></div>
            <div className="absolute -bottom-4 -right-4 h-32 w-32 rounded-full bg-gradient-to-br from-blue-400 to-purple-500 opacity-20 blur-xl"></div>
            ...
            <div className="absolute top-8 right-8 rounded-full bg-white/90 p-3 shadow-lg backdrop-blur-sm dark:bg-black/90">
