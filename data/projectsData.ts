...
const projectsData: ProjectData[] = [
  {
   ...
   AI-powered coding assistant that employs  the use of Large Language Models (LLMs), context retrieval, code indexing, and workflow orchestration to generate code, automate tasks, and improve developers' output.`,
    ...
    skills:
      "Event-Driven architecture, Workflow Orchestration, React, Generative AI, RAG, VectorDB, SQLite, Abstract Synthax Tree (AST), MCP, CodeIndexing",
  ...
  },
  {
    ...
    skills:
      "Typescript, React, NestJs, MongoDB, RBAC, Authentication, State management",
  ...
  },
  {
    ...
    titleLink: "https://github.com/olasunkanmi-SE/ts-codebase-analyzer",
    skills:
      "Event-Driven architecture, CQRS, (CI/CD), SDKs, Containerization, Message Broker, postgreSQL, MongoDB, Microservices, Web Application Security, AWS",
    designPattern:
